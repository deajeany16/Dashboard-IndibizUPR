...
class CustomSurveiDialog extends StatelessWidget {
  const CustomSurveiDialog(
      {super.key,
                  ...
                  child: Row(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(
                            title == "Tambah Survei" ? Icons.add : Icons.edit,
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          MySpacing.height(25),
                          MyText.labelMedium("Alamat Usaha"),
                          MySpacing.height(8),
                          TextFormField(
                            validator: validator.getValidation('alamatusaha'),
                            controller: validator.getController('alamatusaha'),
                            keyboardType: TextInputType.name,
                            decoration: InputDecoration(
                              labelText: "JL. ABCD",
                              labelStyle: MyTextStyle.bodySmall(xMuted: true),
                          ...
                          MySpacing.height(25),
                          MyText.labelMedium("Jenis Usaha"),
                          MySpacing.height(8),
                          TextFormField(
                            validator: validator.getValidation('jenisusaha'),
                            controller: validator.getController('jenisusaha'),
                            keyboardType: TextInputType.name,
                            decoration: InputDecoration(
                              labelText: "eg. Retail",
                              labelStyle: MyTextStyle.bodySmall(xMuted: true),
