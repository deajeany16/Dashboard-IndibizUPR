...
class CustomKriteriaDialog extends StatelessWidget {
  const CustomKriteriaDialog(
      {super.key,
                  ...
                  child: Row(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(
                            title == "Tambah Kriteria" ? Icons.add : Icons.edit,
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          MyText.labelMedium("Kriteria"),
                          MySpacing.height(8),
                          TextFormField(
                            validator: validator.getValidation('kriteria'),
                            controller: validator.getController('kriteria'),
                          ...
                          MySpacing.height(25),
                          MyText.labelMedium("Jumlah Kriteria"),
                          MySpacing.height(8),
                          TextFormField(
                            validator:
                                validator.getValidation('jumlahkriteria'),
                            controller:
                                validator.getController('jumlahkriteria'),
                            keyboardType: TextInputType.name,
                            decoration: InputDecoration(
                              labelText: "eg: 1",
                              labelStyle: MyTextStyle.bodySmall(xMuted: true),
                          ...
                          MySpacing.height(25),
                          MyText.labelMedium("Normalisasi"),
                          MySpacing.height(8),
                          TextFormField(
                            validator: validator.getValidation('normalisasi'),
                            controller: validator.getController('normalisasi'),
                            keyboardType: TextInputType.name,
                            decoration: InputDecoration(
                              labelText: "eg: 1.1",
                              labelStyle: MyTextStyle.bodySmall(xMuted: true),
